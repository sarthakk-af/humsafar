...
const AuthProvider = ({ children }) => {
    ...
    const signIn = async (data) => {
        try {
            const response = await fetch(`http://10.0.22.19:8000/api/user-login`, {
                method: 'POST',
                headers: {
    ...
    const signUp = async (data, navigation) => {
        try {
            const response = await fetch('http://10.0.22.19:8000/api/user-registration', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    Accept: 'application/json'
    ...
    const updateInterests = async (data) => {
        try {
            const response = await fetch(`http://10.0.22.19:8000/api/update-interests/${data.userId}/interests`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    Accept: 'application/json'
